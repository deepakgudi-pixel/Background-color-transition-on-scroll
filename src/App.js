    ...
    <div className="main h-screen w-full flex flex-col  overflow-auto ">
      ...
      >
        <div className="w-full  text-[9vw] leading-[1.1] tracking-tighter ">
          <span className="text-left">Scroll To Change</span>
          <div className="text-left">
            <span className="text-green">Background Color</span>
          </div>
        </div>
      </section>
      <section
      ...
      >
        <div className="w-full flex items-center justify-around">
          ...
          <div className="w-96 text-5xl mx-8">
            Look deep into
            <span className="text-green">Yourself</span> , and then you will
